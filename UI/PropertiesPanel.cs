        ...
        if (ImGui.CollapsingHeader("Metadata"))
        {
            ...
            if (meta != null)
            {
                ...
                if (meta.Size.HasValue)
                    DrawProperty("Physical Size",
                        $"{meta.Size.Value.X:F2} × {meta.Size.Value.Y:F2} × {meta.Size.Value.Z:F2} {meta.SizeUnit}");
                ...
                // Custom fields
                foreach (var kvp in meta.CustomFields) DrawProperty(kvp.Key, kvp.Value);
            }
            else
            {
            ...
            if (ImGui.Button("Edit Metadata...")) _metadataEditor.Open(_dataset);
