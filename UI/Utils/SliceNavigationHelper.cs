...
namespace GeoscientistToolkit.UI.Utils
{
    ...
    public static class SliceNavigationHelper
    {
        ...
        {
            bool changed = false;
            int originalSlice = currentSlice;
            ...
            float sliderWidth = availableWidth - (buttonWidth * 2) - inputWidth - 120; // Account for spacing and label
            ...
            int displaySlice = currentSlice + 1; // Convert to 1-based for display
            ...
            {
                currentSlice = Math.Clamp(currentSlice, 0, maxSlice);
            }
        ...
        public static bool DrawCompactSliceControls(string label, ref int currentSlice, int maxSlice, string id = "")
        {
            ...
            if (ImGui.SliderInt($"##{id}", ref currentSlice, 0, maxSlice, ""))
            {
                changed = true;
            }
            ImGui.SameLine();
