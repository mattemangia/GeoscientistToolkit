...
namespace GeoscientistToolkit.UI
{
    ...
    public class LoadingScreen
    {
        ...
        public LoadingScreen(GraphicsDevice graphicsDevice, CommandList commandList, ImGuiController imGuiController, Sdl2Window window)
        {
        ...
        public void Render()
        {
            ...
            var windowFlags = ImGuiWindowFlags.NoDecoration | ImGuiWindowFlags.NoMove | ImGuiWindowFlags.NoResize | 
                              ImGuiWindowFlags.NoSavedSettings | ImGuiWindowFlags.NoFocusOnAppearing | ImGuiWindowFlags.NoBringToFrontOnFocus;
            
            if (ImGui.Begin("Loading Screen", windowFlags))
            {
                // Dark background
                var drawList = ImGui.GetWindowDrawList();
                drawList.AddRectFilled(viewport.Pos, viewport.Pos + viewport.Size, ImGui.ColorConvertFloat4ToU32(new Vector4(0.1f, 0.1f, 0.12f, 1.0f)));
                ...
                ImGui.SetCursorPos(new Vector2((windowSize.X - subtitleSize.X) * 0.5f, windowSize.Y * 0.35f + textSize.Y * 2f + 10));
                ...
                ImGui.SetCursorPos(new Vector2((windowSize.X - statusSize.X) * 0.5f, windowSize.Y * 0.55f + progressBarHeight + 15));
                ...
                ImGui.SetCursorPos(new Vector2((windowSize.X - dotsSize.X) * 0.5f, windowSize.Y * 0.55f + progressBarHeight + 35));
