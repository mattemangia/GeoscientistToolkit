...
namespace GeoscientistToolkit.UI
{
    public static class ThemeManager
    {
        public static void ApplyTheme(AppearanceSettings settings)
        {
            ...
            // Custom Accent Color
            Vector4 accentColor = GetAccentColor(settings.ColorScheme);
            Vector4 accentColorHover = accentColor * new Vector4(1.2f, 1.2f, 1.2f, 1.0f);
            Vector4 accentColorActive = accentColor * new Vector4(1.4f, 1.4f, 1.4f, 1.0f);
