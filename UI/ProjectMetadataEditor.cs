// GAIA/UI/ProjectMetadataEditor.cs
...
public class ProjectMetadataEditor
{
    ...
    private void SaveMetadata()
    {
        ...
        if (int.TryParse(_yearStr, out var year))
        ...
        if (DateTime.TryParse(_startDateStr, out var startDate))
            _tempMetadata.StartDate = startDate;
        else
            _tempMetadata.StartDate = null;

        if (DateTime.TryParse(_endDateStr, out var endDate))
