    ...
    public sealed class MaterialLibrary
    {
        ...
        private void SeedDefaults()
        {
            ...
            _materials.Add(new PhysicalMaterial
            {
                ...
                Sources = new List<string>{ "Rock property compilations: Schön, Jaeger, Carmichael; Eng. tables.", "MakeItFrom.com for tensile strength [5]" },
                IsUserMaterial = false
            });
            _materials.Add(new PhysicalMaterial
            {
                ...
                Sources = new List<string>{ "Rock property compilations; Eng. tables.", "Johnson and Degraff, 1988 for tensile strength [47]" },
                IsUserMaterial = false
            });
            _materials.Add(new PhysicalMaterial
            {
            ...
            _materials.Add(new PhysicalMaterial
            {
                ...
                Sources = new List<string>{ "Rock property compilations; Eng. tables.", "Geological Society of London for Mag. Sus." },
                IsUserMaterial = false
            });
            _materials.Add(new PhysicalMaterial
            {
