...
namespace GeoscientistToolkit.Analysis.Transform
{
    ...
    public static class TransformIntegration
    {
            ...
            bool clickedFromItem, bool draggingFromItem, bool releasedFromItem)
        {
            ...
            bool clicked  = (clickedFromItem  || (insideImage && ImGui.IsMouseClicked(ImGuiMouseButton.Left)));
            bool dragging = (draggingFromItem || (insideImage && ImGui.IsMouseDragging(ImGuiMouseButton.Left)));
            bool released = (releasedFromItem || ImGui.IsMouseReleased(ImGuiMouseButton.Left));
            ...
            if (!insideImage && !(overlay is null))
            {
                ...
                if (!dragging && !released) return false;
            }
