...
namespace GeoscientistToolkit.Analysis.Materials
{
    ...
    {
        private int _selectedDatasetMaterialIndex = 0;
        private int _selectedLibraryMaterialIndex = 0;
        ...
        public void Draw(Dataset dataset)
        {
            ...
            ImGui.TextWrapped("Assign predefined physical properties from the library to your dataset's materials. This will also update the material's density.");
            ...
            ImGui.SetNextItemWidth(-1);
            if (ImGui.Combo("##LibraryMaterial", ref _selectedLibraryMaterialIndex, libraryNames.ToArray(), libraryNames.Count))
            {
            ...
            else
            {
                ...
                {
                    ImGui.Indent();
                    ImGui.TextColored(new System.Numerics.Vector4(0.6f, 0.8f, 1.0f, 1.0f), physMat.Name);
        ...
        private void AssignMaterial(CtImageStackDataset ct, Material targetMaterial, List<GeoscientistToolkit.Data.Materials.PhysicalMaterial> libraryMaterials)
        {
            ...
            else
            {
                ...
                Logger.Log($"[PhysMat] Assigned '{assignedPhysMat.Name}' to '{targetMaterial.Name}'. Density updated to {targetMaterial.Density:F3} g/cm³.");
            }
            ct.SaveMaterials();
        }
        ...
        private void UpdateLibrarySelection(Material datasetMaterial)
        {
            ...
            {
                int index = MaterialLibrary.Instance.Materials
                    .Select((m, i) => new { Material = m, Index = i + 1 })
                    .FirstOrDefault(x => string.Equals(x.Material.Name, datasetMaterial.PhysicalMaterialName, StringComparison.OrdinalIgnoreCase))?.Index ?? 0;
