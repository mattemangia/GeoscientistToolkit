...
public class AcousticSimulationUI : IDisposable
{
    ...
    public void DrawPanel(CtImageStackDataset dataset)
    {
        ...
        if (ImGui.CollapsingHeader("Material Properties"))
        {
            ...
            if (_lastResults != null && primaryMaterial != null)
            {
                ...
                var density = (float)primaryMaterial.Density; // in g/cm³
        ...
        if (ImGui.CollapsingHeader("Source Parameters"))
        {
            ...
            ImGui.SameLine();
            if (ImGui.Button("Auto")) _timeSteps = CalculateEstimatedTimeSteps(dataset);
            if (ImGui.IsItemHovered())
                ImGui.SetTooltip(
    ...
    private int CalculateEstimatedTimeSteps(CtImageStackDataset dataset)
    {
        ...
        try
        {
            ...
            var vp_avg = 5000f; // Fallback average velocity
            var vp_max = 5000f; // Fallback maximum velocity
            ...
            foreach (var materialId in _selectedMaterialIDs)
            {
                ...
                var density_g_cm3 = (float)material.Density;
            ...
            // CORRECTED: Convert pixel size and thickness from µm to meters for calculation.
            ...
            var dt_est = 0.5f * (pixelSizeM / (1.732f * vp_max));
            ...
            var p_wave_steps = (int)(travelTime / dt_est);
            ...
            var total_steps = (int)(p_wave_steps * 2.25);
