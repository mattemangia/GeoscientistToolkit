...
using System.Linq;
using System.Text; // Using StringBuilder for cleaner string construction
...
namespace GeoscientistToolkit.CustomAddIns
{
    ...
    public class DatasetInfoTool : AddInTool
    {
        ...
        public override void Execute(Dataset dataset)
        {
            ...
            CrossPlatformMessageBox.Show(infoBuilder.ToString(), "Dataset Information", MessageBoxType.Information);
        ...
        public IEnumerable<AddInMenuItem> GetMenuItems()
        {
            return new List<AddInMenuItem>
            {
                new AddInMenuItem
                {
                    ...
                    OnClick = () =>
                    {
                        CrossPlatformMessageBox.Show("Hello from the Sample Add-In!", "Hello World", MessageBoxType.Information);
                    },
                    IsEnabled = () => true
                }
            };
