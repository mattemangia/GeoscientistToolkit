...
namespace GeoscientistToolkit.AddIns.CtSimulation
{
    ...
    public abstract class SimulationResult
    {
        ...
        /// </summary>
        public virtual Texture Get3DTexture(ResourceFactory factory) => null;
        
        /// <summary>
        /// Gets scalar field data
        /// </summary>
        public virtual float[,,] GetScalarField() => null;
        
        /// <summary>
        /// Gets vector field data
        /// </summary>
        public virtual Vector3[,,] GetVectorField() => null;
        
        /// <summary>
        /// Gets modified label data
        /// </summary>
        public virtual byte[,,] GetLabelData() => null;
