...
public class AddInManager
{
    ...
    public void LoadAddIn(IAddIn addIn)
    {
        ...
        try
        {
            ...
            if (tools != null) _tools.AddRange(tools);

            // Collect importers
            var importers = addIn.GetDataImporters();
            if (importers != null) _importers.AddRange(importers);

            // Collect exporters
            var exporters = addIn.GetDataExporters();
            if (exporters != null) _exporters.AddRange(exporters);
        ...
        catch (Exception ex)
        {
            ...
            if (_loadedAddIns.ContainsKey(addIn.Id)) _loadedAddIns.Remove(addIn.Id);
        }
    }
    ...
    public void Shutdown()
    {
        ...
        foreach (var addInId in addInIds) UnloadAddIn(addInId);
    }
    ...
    /// </summary>
    public IEnumerable<AddInTool> GetToolsForDataset(Dataset dataset)
    {
