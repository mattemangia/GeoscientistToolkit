...
public class PNMViewer : IDatasetViewer
{
    ...
    private void InitializeVeldridResources()
    {
        ...
        var depthDesc = TextureDescription.Texture2D(_renderTexture.Width, _renderTexture.Height, 1, 1, depthFormat,
...
void main() 
{
    ...
    out_Color = vec4(color * diffuse + vec3(spec), 1.0);
        ...
        _poreConstantsBuffer = factory.CreateBuffer(new BufferDescription((uint)Marshal.SizeOf<Constants>(),
        ...
        _poreResourceSet = factory.CreateResourceSet(new ResourceSetDescription(_poreResourceLayout,
            _poreConstantsBuffer, _colorRampTexture, sampler));
        ...
        var poreVertexLayouts = new[]
        {
            ...
            new VertexLayoutDescription(
                ...
                new VertexElementDescription("in_InstancePosition", VertexElementSemantic.TextureCoordinate,
                    VertexElementFormat.Float3),
                new VertexElementDescription("in_InstanceColorValue", VertexElementSemantic.TextureCoordinate,
                    VertexElementFormat.Float1),
                new VertexElementDescription("in_InstanceRadius", VertexElementSemantic.TextureCoordinate,
                    VertexElementFormat.Float1)
            )
        };
...
void main() 
{
    ...
    out_Color = vec4(color, 1.0);
        ...
        _throatConstantsBuffer = factory.CreateBuffer(new BufferDescription((uint)Marshal.SizeOf<Constants>(),
            BufferUsage.UniformBuffer | BufferUsage.Dynamic));
        ...
        _throatResourceSet = factory.CreateResourceSet(new ResourceSetDescription(_throatResourceLayout,
            _throatConstantsBuffer, _colorRampTexture, sampler));
        ...
        _throatPipeline = factory.CreateGraphicsPipeline(new GraphicsPipelineDescription(
            ...
            new ShaderSetDescription(new[]
            {
                new VertexLayoutDescription(
                    new VertexElementDescription("in_Position", VertexElementSemantic.TextureCoordinate,
                        VertexElementFormat.Float3),
                    new VertexElementDescription("in_ColorValue", VertexElementSemantic.TextureCoordinate,
                        VertexElementFormat.Float1)
                )
            }, shaderSet),
