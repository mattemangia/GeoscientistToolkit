...
public static class AcousticInteractionManager
{
    ...
    public static bool IsLineDefinitionActive { get; set; }
    ...
    public static bool HasNewLine { get; set; }

    // --- NEW: Properties for a single point ---
    public static bool IsPointDefinitionActive { get; set; }
    public static Vector3 SelectedPoint { get; set; } // Using Vector3 for 3D volume coordinates
    public static bool HasNewPoint { get; set; }
