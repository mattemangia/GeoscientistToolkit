...
### CT Image Stack Commands (14 commands)
...
#### CT_LIST_MATERIALS
List materials in the CT stack.
...
#### CT_MATERIAL_STATS
Generate a material statistics table from the CT stack.
...
**CT Image Stack (14):**
CT_SEGMENT, CT_FILTER3D, CT_ADD_MATERIAL, CT_REMOVE_MATERIAL, CT_LIST_MATERIALS, CT_MATERIAL_STATS, CT_ANALYZE_POROSITY, CT_CROP, CT_EXTRACT_SLICE, CT_LABEL_ANALYSIS, SIMULATE_ACOUSTIC, SIMULATE_NMR, SIMULATE_THERMAL_CONDUCTIVITY, SIMULATE_GEOMECH
