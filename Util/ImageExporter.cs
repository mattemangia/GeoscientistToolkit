...
namespace GeoscientistToolkit.Util
{
    public static class ImageExporter
    {
        ...
        public static void SaveTexture(GraphicsDevice gd, CommandList cl, Texture source, Rectangle sourceRect, string filePath)
        {
        ...
        /// </summary>
        private static unsafe void WriteBitmap(string filePath, int width, int height, MappedResource mappedResource)
        {
            uint stride = mappedResource.RowPitch;
            int bytesPerPixel = 4; // Assuming 32-bit format (BGRA8 or RGBA8)
            ...
            using (var writer = new BinaryWriter(stream))
            {
                ...
                for (int y = height - 1; y >= 0; y--)
                {
                    ...
                    IntPtr sourcePtr = (IntPtr)((long)mappedResource.Data + (y * stride));
